...
const _SKINS=[
  ...
  {name:'Da Qi',   value:'daqi', colors:['#993366','#CC6699','#7A2952']},
...
function _setResolvedTheme(isDark){
  ...
  const want=isDark
    ?'static/vendor/prismjs/themes/prism-tomorrow.min.css'
    :'static/vendor/prismjs/themes/prism.min.css';
  ...
  try{
    ...
    if(typeof setLocale==='function'){
      const _lang=typeof resolvePreferredLocale==='function'
        ...
        : (s.language || localStorage.getItem('hermes-lang') || 'zh-CN');
      setLocale(_lang);
    ...
    if(typeof setLocale==='function'){
      const _lang=typeof resolvePreferredLocale==='function'
        ...
        : (localStorage.getItem('hermes-lang') || 'zh-CN');
      setLocale(_lang);
      if(typeof applyLocaleToDOM==='function')applyLocaleToDOM();
    }
    if(typeof _applyTtsEnabled==='function') _applyTtsEnabled(localStorage.getItem('hermes-tts-enabled')==='true');
